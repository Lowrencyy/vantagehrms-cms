    ...
    <div class="item">
        <div class="container">
            <div class="row align-center">
                <div class="col-lg-6">
                    <div class="content">
                        <h2 class="wow fadeInDown font-banner">{{ $banner->title ?? 'Default Title' }} <strong>{{ $banner->subtitle ?? 'Default Subtitle' }}</strong></h2>
                        <p class="wow fadeInLeft">{{ $banner->description ?? 'Default Description: We do our best to implement your ideas into the project to make it successful and profitable.' }}</p>
